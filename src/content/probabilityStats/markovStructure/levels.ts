...
export const markovStructureLevels: Level[] = [
  ...
  },
  {
    ...
    lesson: {
      paragraphs: [
        "States are classified by their long-run behaviour. RECURRENT = you return with probability 1 (visited infinitely often); TRANSIENT = you return with probability < 1 (visited only finitely often). In a FINITE, irreducible chain every state is recurrent — probability can't leak away. PERIODICITY is the gcd of possible return times; a self-loop (P_{ii}>0) forces period 1 (aperiodic).",
