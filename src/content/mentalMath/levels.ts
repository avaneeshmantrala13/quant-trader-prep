 ...
 * the timed mental-math screen many quant firms gate candidates on, whether the
 * questions are direct arithmetic or fast probability.
 */
const levels: Level[] = [
  {
    id: "mm-1",
    ...
    lesson: {
      paragraphs: [
        "Mental math is the GATE at most trading firms: many run a fast, timed arithmetic screen before anything else. Speed comes from decomposition: add hundreds→tens→ones; multiply by splitting a two-digit number into its tens and ones.",
...
export const mentalMathTrack: Track = {
  id: "mental-math",
  title: "Mental Math",
  tagline: "Timed, exact speed arithmetic and trader conversions",
  description:
