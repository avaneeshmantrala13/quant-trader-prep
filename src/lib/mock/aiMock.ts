...
export async function generateFollowup(
  ...
  // A PINNED authored follow-up is never regenerated by the AI: return it
  // verbatim so a hand-authored reasoning adversarial (e.g. the Optiver
  // quadratic demo that leads the demo mock) stays reasoning-graded and is never
  // downgraded to a numeric ask, even when the live AI layer is active.
  if (args.authored.lockAuthored) return args.authored;
