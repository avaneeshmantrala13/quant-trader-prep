    ...
    <div className="animate-print-in space-y-5">
      <article className="panel-ruled p-6">
        ...
        <p className="mt-3 text-[15px] leading-relaxed text-secondary">
          ...
          two-sided market under a hard max-spread. An informed counterparty will pick off any
          price you leave stale — your job is to price defensibly, skew when you get lifted, and
          manage your position to a break-even you can defend.
        </p>

        <div className="mt-5 grid gap-3 sm:grid-cols-3">
          <Rule icon={<GaugeIcon width={16} height={16} />} title="Quote both sides">
            Bid you'll buy at, ask you'll sell at. Never get traded on your 95% interval.
          </Rule>
          <Rule icon={<BoltIcon width={16} height={16} />} title="Read the aggression">
            Getting lifted repeatedly means you're too cheap — skew your whole market, add size.
          </Rule>
